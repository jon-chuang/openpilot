...
def create_lat_ctl_msg(packer, lat_active: bool, curvature: float, lateral_motion_control: dict):
  """
  ...
  lateral_motion_control["LatCtlCurv_No_Actl"] = curvature
  lateral_motion_control["LatCtl_D_Rq"] = 1 if lat_active else 0
  ...
  # }
  return packer.make_can_msg("LateralMotionControl", CANBUS.main, lateral_motion_control)
